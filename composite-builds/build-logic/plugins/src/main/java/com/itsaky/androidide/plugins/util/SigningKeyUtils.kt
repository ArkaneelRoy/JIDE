...
package com.willow.androidide.ultra.plugins.util

import com.willow.androidide.ultra.build.config.AUTH_PASS
import com.willow.androidide.ultra.build.config.AUTH_USER
import com.willow.androidide.ultra.build.config.KEY_BIN
import com.willow.androidide.ultra.build.config.KEY_URL
