...
import com.willow.androidide.ultra.lsp.util.DocumentationReferenceProvider
import com.willow.androidide.ultra.progress.ProgressManager
import com.willow.androidide.ultra.utils.KeyboardUtils
  ...
  override fun setLayout(layout: CompletionLayout) {
    ...
    (layout.completionList as? ListView)?.let {
      ...
      it.setOnItemLongClickListener { _, view, position, _ ->
        val data =
          (items[position] as? com.willow.androidide.ultra.lsp.models.CompletionItem)?.data
