...
import com.willow.androidide.ultra.databinding.LayoutCrashReportBinding
import com.willow.androidide.ultra.resources.R
import com.willow.androidide.ultra.utils.BuildInfoUtils
...
class CrashReportFragment : Fragment() {
  ...
  private fun reportTrace(report: String) {
    ClipboardUtils.copyText("AndroidIDE Ultra CrashLog", report)
