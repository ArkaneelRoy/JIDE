...
data class ConnectionObserverParams(val clientId: String, val totalConnections: Int) {
  ...
  companion object {
    ...
    const val KEY_CLIENT_ID = "com.willow.androidide.ultra.logreceiver.connectedClientId"
    const val KEY_CONNECTION_COUNT = "com.willow.androidide.ultra.logreceiver.connectionCount"
