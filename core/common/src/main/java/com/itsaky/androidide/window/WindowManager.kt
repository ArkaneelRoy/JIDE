...
class WindowManager(
   ...
   * from the [com.willow.androidide.ultra.window.sidecar.SidecarInterface] or is passed directly to the
   * [com.willow.androidide.ultra.window.extensions.ExtensionInterface].
   */
