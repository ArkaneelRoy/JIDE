...
package com.willow.androidide.ultra.eventbus.events.editor
 ...
 * color schemes.
 *
 * For example, on receiving this event, the editors in AndroidIDE Ultra invalidate themselves to redraw
