...
import com.willow.androidide.ultra.logsender.socket.ISocketCommand;
import com.willow.androidide.ultra.logsender.socket.SenderInfoCommand;
...
public class LogReader extends Thread {
  ...
  public LogReader(String senderId, String packageName, int port, String[] cmd) {
    super("AndroidIDE Ultra-LogReader");
