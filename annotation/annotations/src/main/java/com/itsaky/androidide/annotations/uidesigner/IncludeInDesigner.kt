...
package com.willow.androidide.ultra.annotations.uidesigner

/**
 * Indicates that the view (whose view adapter is annotated with [ViewAdapter]
 * [com.willow.androidide.ultra.annotations.inflater.ViewAdapter] and [IncludeInDesigner]) should be
