## **AndroidIDE Ultra v2.0.0-beta**

AndroidIDE Ultra v2.0.0-beta is here with new features and improvements.
...
- The AndroidIDE Ultra Gradle plugin is now packaged with the IDE.
