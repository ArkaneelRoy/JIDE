# AndroidIDE Ultra Version v2.7.0-beta Changelog
...
- Support for `x86_64` CPUs has been added! You can now use AndroidIDE Ultra on emulators and WSA (Windows Subsystem for Android).
- This version adds a new onboarding experience for AndroidIDE Ultra (#1399).
- The 'About' screen has been updated to include information about the people who have contributed to the AndroidIDE Ultra project.
...
We believe that you'll have a delightful experience using AndroidIDE Ultra v2.7.0-beta!
