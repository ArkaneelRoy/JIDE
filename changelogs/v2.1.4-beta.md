# **AndroidIDE Ultra v2.1.4-beta**

This release improves the UI Designer, adds support for custom custom color schemes in editor and much more.

## Important notes
- Enjoy an experience closer to your device with Dynamic colors support in AndroidIDE Ultra. This is enabled by default but can be disabled in IDE preferences.
