# AndroidIDE Ultra v2.3.0-beta

This release fixes some minor issues in AndroidIDE Ultra.
...
- AndroidIDE Ultra crashes if the built application cannot be launched. #759.
