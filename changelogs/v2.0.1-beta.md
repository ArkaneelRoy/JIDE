# **AndroidIDE Ultra v2.0.1-beta**

AndroidIDE Ultra v2.0.1-beta is here with new features, improvements and bug fixes.
...
- As 64-bit installation does not work on Android 12 (due
  ...
  build tools need to be installed when installing AndroidIDE Ultra on devices running Android 12.
