# **AndroidIDE Ultra v2.1.0-beta**

AndroidIDE Ultra v2.0.0-beta is here with new features, improvements, bug fixes and a whole new

### Important notes

- The `HOME` and `SYSROOT` directories has been renamed to `home` and `usr` respectively.
- The packages for the AndroidIDE Ultra terminal has been updated. But, it requires you to reinstall the
  bootstrap packages. Please follow [this](https://t.me/androidide_discussions/30564) guide to
  install the new bootstrap packages.
- Android 12 devices no longer need to use 32-bit build tools. You can simply reinstall AndroidIDE Ultra
...
- The minimum Android Gradle Plugin version required to build projects in AndroidIDE Ultra is now set to
...
* @BryanGIG made their first contribution in https://github.com/AndroidIDE UltraOfficial/AndroidIDE Ultra/pull/179
* @MrIkso made their first contribution in https://github.com/AndroidIDE UltraOfficial/AndroidIDE Ultra/pull/180
* @AndreyKozhev made their first contribution in https://github.com/AndroidIDE UltraOfficial/AndroidIDE Ultra/pull/181

**Full Changelog**: https://github.com/AndroidIDE UltraOfficial/AndroidIDE Ultra/compare/v2.0.1-beta...v2.1.0-beta