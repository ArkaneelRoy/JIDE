...
import com.willow.androidide.ultra.inflater.internal.utils.ViewFactory
import com.willow.androidide.ultra.inflater.viewGroup
import com.willow.androidide.ultra.lookup.Lookup
import com.willow.androidide.ultra.uidesigner.utils.UiInflaterComponentFactory
...
fun Context.createLayout(parent: com.willow.androidide.ultra.inflater.IViewGroup? = null): ViewGroupImpl {
...
fun Context.createView(parent: com.willow.androidide.ultra.inflater.IViewGroup? = null): ViewImpl {
  return ViewImpl(LayoutFile(File(""), ""), View::class.qualifiedName!!, View(this)).apply {
    parent?.let { applyLayoutParams(it) }
  }
}

fun ViewImpl.applyLayoutParams(parent: com.willow.androidide.ultra.inflater.IViewGroup) {
