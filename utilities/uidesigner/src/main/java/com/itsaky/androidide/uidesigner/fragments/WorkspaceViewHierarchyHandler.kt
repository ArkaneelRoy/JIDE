...
import com.willow.androidide.ultra.uidesigner.undo.ViewRemovedAction
...
internal class WorkspaceViewHierarchyHandler :
  ...
  private fun pushAction(view: com.willow.androidide.ultra.inflater.IView,
  ...
  override fun beforeViewAdded(group: IViewGroup,
                               view: com.willow.androidide.ultra.inflater.IView,
                               index: Int
  ) {
    animateLayoutChange()
  }
