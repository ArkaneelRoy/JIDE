...
package com.willow.androidide.ultra.inflater.vectormaster.models;
...
import com.willow.androidide.ultra.inflater.vectormaster.DefaultValues;
import com.willow.androidide.ultra.inflater.vectormaster.utilities.Utils;
import com.willow.androidide.ultra.inflater.vectormaster.utilities.parser.PathParser;
...
public class PathModel {
  ...
  public void buildPath(boolean useLegacyParser) {
    if (useLegacyParser) {
      originalPath =
          com.willow.androidide.ultra.inflater.vectormaster.utilities.legacyparser.PathParser.createPathFromPathData(
              pathData);
    } else {
